...
import { Text, Box, Heading, Avatar, Center, HStack, ScrollView, Button } from 'native-base'
            ...
            <Box>
                <Box m={2}>
                    <Center py={5} shadow={2} bg={{
                        ...
                        <Heading mt={3} color='white'>{elderlyInfo.name}</Heading>
                    </Center>
                    ...
                    <Box mt={2}>
                        ...
                        <InfoCard label='Senior BMI' data={(elderlyInfo.weight / ((elderlyInfo.height / 100) * (elderlyInfo.height / 100))).toFixed(2)} />
                        <InfoCard label='Gender' data={elderlyInfo.gender || 'M'} />
                        <InfoCard label='Senior Height' data={elderlyInfo.height || 173} unit="cm" />
                        <InfoCard label='Senior Weight' data={elderlyInfo.weight || 68} unit='kg' />
                    </Box>
