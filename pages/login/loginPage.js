...
const LoginArea = (props) => {
    ...
    return (
        <>
            ...
            <Box
                bg='white' shadow={2} w="90%" py="6" px="10">
                ...
                <VStack space={3} mt="5">
                    ...
                    <FormControl>
                        ...
                        <Input type="password" onChangeText={text => setPw(text)} value={pw}
                            placeholder='Enter password' />
                    </FormControl>
                    <Button mt="2" onPress={() => { submitHandler() }}
                        isLoading={loading}>
                        Sign in
                    </Button>
                </VStack>
...
const mapDispatchToProps = (dispatch) => ({
    ...
    dispatchLogin: (payload) => dispatch({
        type: 'loginAsUser', payload: payload
    })
