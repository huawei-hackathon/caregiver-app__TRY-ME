...
import { HStack, Image, Box, Text, Center, VStack, ArrowForwardIcon, ArrowBackIcon, ChevronRightIcon, ChevronLeftIcon, Pressable, ScrollView, Spinner, View } from "native-base";
...
const MealPage = () => {
    ...
    useEffect(async () => {
        ...
        const mealsInfo = await getDateMeal(store.getState().userInfo.elderlyId, date.toISOString().slice(0, 10))
                ...
                {(mealInfo.length > 0 && !isEmpty) &&
                    <>
                        ...
                        >
                            ...
                            <Text
                                bold
                                fontSize='lg'>{mealInfo[index].time}</Text>
                        </HStack>
                        ...
                        <MealConts
                            zIndex={-1}
                            contents={mealInfo[index].contents} />
                    </>
                }
